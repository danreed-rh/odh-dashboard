/* eslint-disable no-console, import/no-extraneous-dependencies, n/no-extraneous-require */
...
module.exports = (env) => ({
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      title: PRODUCT_NAME,
      favicon: path.join(SRC_DIR, 'images', FAVICON || 'favicon.ico'),
  ...
  resolve: {
    ...
    alias: {
      ...
      // Force one QueryClient context: openshell-dashboard ships its own nested v5 copy.
      '@tanstack/react-query': path.resolve(RELATIVE_DIRNAME, 'node_modules/@tanstack/react-query'),
    },
    symlinks: false,
